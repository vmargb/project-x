...
;; - project-x-layout persists multiple window configurations in the same project
;;
;;; Code:
...
`project-kill-buffers' closes the project's tab."
  ...
  (unless project-x-mode
    (error "Error: project-x-tabs-mode requires project-x-mode to be enabled first"))

  (if project-x-tabs-mode
      (progn
        (when (< emacs-major-version 28)
          (setq project-x-tabs-mode nil)
          (error "Error: project-x-tabs-mode requires Emacs 28 or later"))
        (require 'tab-bar)
        (tab-bar-mode 1)
